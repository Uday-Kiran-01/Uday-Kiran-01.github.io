...
const MarqueeBlock: React.FC<{ title: string; items: any[]; duration?: string }> = ({ title, items, duration = '28s' }) => {
  ...
  return (
    <section className="books-section">
      <div className="books-section-header">
        ...
        <div className="marquee-controls">
          <button
            ...
            aria-pressed={paused}
            aria-label={paused ? `Resume ${title} marquee` : `Pause ${title} marquee`}
      ...
      <div className="books-marquee" aria-label={`${title} books`}>
...
const Reading: React.FC = () => {
  ...
  return (
    <div className="reading-container">
      ...
      <p className="reading-intro">Completed and ongoing books — updated from your other branch.</p>
